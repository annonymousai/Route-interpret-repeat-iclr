...
from Baseline.experiments_baseline_cub import train_backbone, test_explainer
...
parser.add_argument('--bb-chkpt', metavar='DIR',
                    default='/ocean/projects/asc170022p/shg121/PhD/ICLR-2022/checkpoints/cub/Baseline/lr_0.001_epochs_95/ResNet101',
                    help='bb-chkpt')
parser.add_argument('--bb-chkpt-file', metavar='DIR',
                    default='g_best_model_epoch_61.pth.tar',
                    help='bb-chkpt')
...
parser.add_argument('--train_baseline_backbone', type=str, default="y", help='backbone or explainer')
parser.add_argument('--img-size', type=int, default=448, help='image\'s size for transforms')
parser.add_argument(
    '--bs', '--batch-size', '--train_batch_size', '--eval_batch_size', default=16, type=int,
...
parser.add_argument('--lr_explainer', default=0.001, type=float,
                    metavar='LR', help='initial learning rate')
...
parser.add_argument('--epochs_g', type=int, default=500, help='batch size for training')
parser.add_argument('--arch', type=str, default="ResNet101", help='ResNet50 or ResNet101 or ResNet152')
...
def main():
    ...
    if args.train_baseline_backbone == "y":
        print("Train backbone of baseline for CUB")
        train_backbone(args)
    else:
        print("Train explainer of baseline for CUB")
        # train_explainer(args)
        test_explainer(args)
