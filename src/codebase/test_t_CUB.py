...
parser.add_argument('--save-concepts', type=bool, default=True, help='saving the concepts or just test the t model?')
...
parser.add_argument('--projected', type=str, default="n", required=False, help='y or n')
...
parser.add_argument('--root-explainer', metavar='file',
                    default='_cov_1.0/iter1/t_projected/batch_norm_n_finetune_y',
                    help='checkpoint folder of BB')
...
def main():
    ...
    print("Inputs")
    if args.spurious_specific_classes == "y" and (
