...
class Residual(nn.Module):
    def __init__(self, dataset, pre_trained=True, n_class=200, model_choice="ResNet50"):
        ...
        if (dataset == "cub" or dataset == "awa2") and (
        ...
        elif dataset == "mimic_cxr" and model_choice == "densenet121":
    ...
    def forward(self, x):
        if self.model_choice == "ResNet50" or self.model_choice == "ResNet101" \
            ...
            if self.dataset == "cub" or self.dataset == "mimic_cxr" or self.dataset == "awa2":
